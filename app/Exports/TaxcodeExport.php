...
class TaxcodeExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function map($tax_code): array
    {
        ...
        return [
            $tax_code['tax_code'],
            $tax_code['label'],
            $tax_code['total_tax_percentage'],
            $tax_code['description'],            
            $tax_code['status']['label'],
            $tax_code['created_at_label'],
            $tax_code['created_by']['fullname'],
            $tax_code['updated_at_label'],
            $tax_code['updated_by']['fullname']
        ];
    }
}
