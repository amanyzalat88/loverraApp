...
class Product extends Model
{
    ...
    protected $fillable = ['slack', 'store_id', 'product_code', 'name', 'description', 'category_id', 'supplier_id', 'tax_code_id', 'discount_code_id', 'quantity', 'purchase_amount_excluding_tax', 'sale_amount_excluding_tax', 'status', 'created_by', 'updated_by'];
