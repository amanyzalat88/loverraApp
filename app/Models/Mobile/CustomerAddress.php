...
class CustomerAddress extends Model
{
    ...
    protected $hidden = ['created_at', 'updated_at', 'country', 'city'];
    protected $fillable = ['id','slack', 'delivery_area', 'building', 'street', 'flatnumber', 'landmark' ,'customer_id','is_default'];
