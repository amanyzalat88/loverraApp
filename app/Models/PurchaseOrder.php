...
class PurchaseOrder extends Model
{
    ...
    protected $fillable = ['slack', 'store_id', 'po_number', 'po_reference', 'po_code', 'supplier_id', 'supplier_code', 'supplier_name', 'supplier_address', 'currency_name', 'currency_code', 'subtotal_excluding_tax', 'total_discount_amount', 'total_after_discount', 'total_tax_amount', 'shipping_charge', 'packing_charge', 'total_order_amount', 'order_date', 'order_due_date', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'];
