...
class Customer extends Model
{
    ...
    protected $hidden = ['id'];
    protected $fillable = ['slack', 'customer_type', 'name', 'email', 'phone', 'address', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'];
    ...
    public function scopeAddress($query){
        return $query->leftJoin('customers_addresses', function ($join) {
