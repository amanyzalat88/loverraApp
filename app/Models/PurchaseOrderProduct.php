...
class PurchaseOrderProduct extends Model
{
    ...
    protected $fillable = ['slack', 'purchase_order_id', 'product_id', 'product_slack', 'product_code', 'name', 'quantity', 'amount_excluding_tax', 'discount_percentage', 'tax_percentage', 'discount_amount', 'total_after_discount', 'tax_amount', 'total_amount', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'];
