    ...
    public function index(Request $request)
    {
        try {
            ...
            foreach($discount_codes as $key => $discount_code){
                ...
                $item_array[$key][] = view('common.status', ['status_data' => ['label' => $discount_code['status']['label'], "color" => $discount_code['status']['color']]])->render();
                $item_array[$key][] = $discount_code['created_at_label'];
                $item_array[$key][] = $discount_code['updated_at_label'];
                $item_array[$key][] = (isset($discount_code['created_by']) && $discount_code['created_by']['fullname'] != '')?$discount_code['created_by']['fullname']:'-';
