    ...
    public function index(Request $request)
    {
        try {
            ...
            foreach($roles as $key => $role){
                ...
                $item_array[$key][] = view('common.status', ['status_data' => ['label' => $role['status']['label'], "color" => $role['status']['color']]])->render();
                $item_array[$key][] = $role['created_at_label'];
                $item_array[$key][] = $role['updated_at_label'];
                $item_array[$key][] = (isset($role['created_by']) && $role['created_by']['fullname'] != '')?$role['created_by']['fullname']:'-';
