        ...
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap mb-4">
                <div class="mr-auto">
                   <div class="d-flex">
                        <div>
                            <span class="text-title"> <span class='text-muted'>Tax Code</span> {{ tax_code.label }} ({{ tax_code.tax_code }}) </span>
                        </div>
                    </div>
                </div>
                <div class="">
            ...
            <div class="form-row mb-2">
                ...
                <div class="form-group col-md-3">
                    <label for="tax_percentage">Total Tax Percentage</label>
            ...
            <div class="mb-3">
                <div class="mb-2">
                    <span class="text-subhead">Tax Components</span>
                </div>
                <div class="col-md-6">
                    <div class="row">
