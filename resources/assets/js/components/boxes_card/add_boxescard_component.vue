        ...
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="d-flex flex-wrap mb-4">
                    <div class="mr-auto">
                        <span class="text-title" v-if="ads_slack == ''">Add Boxes Card</span>
                        <span class="text-title" v-else>Edit Boxes Card</span>
                    </div>
                    <div class="">
    ...
    export default {
        data(){
            return{
                ...
                modal           : false,
                show_modal      : false,
                api_link        : (this.boxes_data == null)?'/api/add_boxescard':'/api/update_boxescard/'+this.boxes_data.slack,
