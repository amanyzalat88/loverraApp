            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="category_name" v-model="category_name" v-validate="'required|max:250'" class="form-control form-control-custom" placeholder="Please enter category name"  autocomplete="off">
