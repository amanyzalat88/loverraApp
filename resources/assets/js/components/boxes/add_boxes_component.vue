        ...
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="d-flex flex-wrap mb-4">
                    <div class="mr-auto">
                        <span class="text-title" v-if="ads_slack == ''">Add Boxes</span>
                        <span class="text-title" v-else>Edit Boxes</span>
                    </div>
                    <div class="">
    ...
    export default {
        data(){
            return{
                ...
                modal           : false,
                show_modal      : false,
                api_link        : (this.boxes_data == null)?'/api/add_boxes':'/api/update_boxes/'+this.boxes_data.slack,

                ads_slack       : (this.boxes_data == null)?"":this.boxes_data.slack,
                ...
                count  : (this.boxes_data == null)?"":this.boxes_data.count,
                ...
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        this.$on("submit",function () {
                            ...
                            formData.append("count", (this.count == null)?'':this.count);
