        ...
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="d-flex flex-wrap mb-4">
                    <div class="mr-auto">
                        <span class="text-title" v-if="supplier_slack == ''">Add Supplier</span>
                        <span class="text-title" v-else>Edit Supplier</span>
                    </div>
                    <div class="">
                ...
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="email" v-model="email" v-validate="'email'" class="form-control form-control-custom" placeholder="Please enter contact email" autocomplete="off">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <textarea name="address" v-model="address" v-validate="'max:65535'" class="form-control form-control-custom" rows="5" placeholder="Enter Address"></textarea>
