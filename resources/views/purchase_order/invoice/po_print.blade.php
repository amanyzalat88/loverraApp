            ...
            <table class='w-100'>
                <tr>
                    <td class='w-50'>
                        ...
                        <div class='display-block'>Order Due Date: {{ $data->order_date }}</div>
                        <div class='display-block'>Order Date: {{ $data->order_due_date }}</div> 
                    </td>
                    <td class='right'>
                        @if($logo_path != '')
        ...
        <div>
            <table class="w-100 product-table mb-1rem">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" class="right">Sub Total (EXCL Tax)</td>
                        <td class="right">{{ $data->subtotal_excluding_tax }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="right">Total Discount</td>
                        <td class="right">{{ $data->total_discount_amount }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="right">Total After Discount</td>
                    ...
                    <tr>
                        <td colspan="6" class="right">Shipping Charge</td>
                        <td class="right">{{ $data->shipping_charge }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="right">Packaging Charge</td>
                        <td class="right">{{ $data->packing_charge }}</td>
                    </tr>
                    <tr>
                        <td colspan="6" class="right bold">Total (INCL Tax)</td>
