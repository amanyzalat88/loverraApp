<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
        @if (check_access(array('A_DETAIL_CUSTOMER'), true))
            <a href="{{ $customer['detail_link'] }}" class="dropdown-item">View</a>
        @endif
        @if (check_access(array('A_EDIT_CUSTOMER'), true))
            <a href="edit_customer/{{ $customer['slack'] }}" class="dropdown-item">Edit</a>
        @endif
         <a href="#" class="dropdown-item">More address</a>
    </div>
</div>