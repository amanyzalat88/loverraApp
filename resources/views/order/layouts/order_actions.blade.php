<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
        @if (check_access(array('A_DETAIL_ORDER'), true))
            <a href="{{ $order['detail_link'] }}" class="dropdown-item">View</a>
        @endif
        @if (check_access(array('A_EDIT_ORDER'), true) && $order['status']['value'] == 0)
            <a href="edit_order/{{ $order['slack'] }}" class="dropdown-item">Edit</a>
        @endif
    </div>
</div>