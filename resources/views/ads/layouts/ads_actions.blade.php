<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown">
        @if (check_access(array('A_DETAIL_ADS'), true))
            <a href="{{ $ads['detail_link'] }}" class="dropdown-item">View</a>
        @endif
        @if (check_access(array('A_EDIT_ADS'), true))
            <a href="edit_ads/{{ $ads['slack'] }}" class="dropdown-item">Edit</a>
        @endif
    </div>
</div>